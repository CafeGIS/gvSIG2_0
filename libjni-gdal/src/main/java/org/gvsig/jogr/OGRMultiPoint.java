/**********************************************************************
 * $Id: OGRMultiPoint.java 7765 2006-10-03 07:05:18Z nacho $
 *
 * Name:     OGRMultiPoint.java
...
public class OGRMultiPoint extends JNIBase{
	...
	/**
	 * Constructor
	 * @param cPtr	dirección de memoria al objeto OGRMultiPoint de C. 
	 */
		
	public OGRMultiPoint(long cPtr){
		this.cPtr=cPtr;
	}		
