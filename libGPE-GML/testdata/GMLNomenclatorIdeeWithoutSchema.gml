...
<ResultCollection xmlns="http://www.idee.es/mne" xmlns:gml="http://www.opengis.net/gml"
  xmlns:wfs="http://www.opengis.net/wfs" xmlns:xlink="http://www.w3.org/1999/xlink"
  xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  xsi:schemaLocation="http://www.idee.es/mne noSchema.xsd">
  <gml:boundedBy>
    <gml:Box>
      <gml:coord>
        <gml:X>-1.13</gml:X>
  ...
  <gml:featureMember>
    <Entidad fid="Entidad.382806">
      <nombreEntidad>
        ...
        <fuente>
          Nomencl�or Geogr�ico Versi� 16.06, Instituto Geogr�ico Nacional (Espa�)
        </fuente>
      </nombreEntidad>
      <nombreEntidad>
      ...
      <tipoEntidad>
        <tipo>Poblaci�</tipo>
        <catalogoEntidades>
          Entidades del Nomencl�or Geogr�ico Versi� 16.06, Instituto Geogr�ico Nacional
          (Espa�)
        </catalogoEntidades>
      </tipoEntidad>
      <posicionEspacial>
