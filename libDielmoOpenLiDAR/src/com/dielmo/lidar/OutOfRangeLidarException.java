...
public class OutOfRangeLidarException extends Exception {

	/**
	 * serial ID
	 */
	private static final long serialVersionUID = -2158284772847124390L;

	/**
	 * Crea un nuevo OutOfRangeLidarException.
	 *
	 * @param s string that identify the cause
	 */
	public OutOfRangeLidarException(String string){
		super(string);
	}
}
