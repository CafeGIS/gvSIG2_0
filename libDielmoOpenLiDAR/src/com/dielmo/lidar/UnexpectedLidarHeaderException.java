...
public class UnexpectedLidarHeaderException extends Exception {

	/**
	 * serial ID
	 */
	private static final long serialVersionUID = -1949928737020052451L;

	/**
	 * Crea un nuevo Unexpected Header.
	 *
	 * @param s string that identify the cause
	 */
	public UnexpectedLidarHeaderException(String string){
		super(string);
	}
