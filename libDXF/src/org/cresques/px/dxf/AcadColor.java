...
public class AcadColor {
    ...
    /**
     * Constructor de AcadColor.
     * @param code, código de color de AutoCAD.
     * @param r0, componente de color rojo (0-1).
     * @param g0, componente de color verde (0-1).
     * @param b0, componente de color azul (0-1).
     * @param r, componente de color rojo (0-255).
     * @param g, componente de color verde (0-255).
     * @param b, compponente de color azul (0-255).
     */
    ...
    /**
     * Devuelve el color de java correspondiente a un código de color de AutoCAD que
     ...
     * la relación entre colores de AutoCAD y colores de java.
     * @return AcadColor[], array de objetos AcadColor con las correspondencias entre
     * los colores de AutoCAD y los colores java.
     */
