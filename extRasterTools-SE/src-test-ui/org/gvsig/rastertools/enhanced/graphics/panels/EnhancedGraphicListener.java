 ...
 */
public class EnhancedGraphicListener  implements ActionListener, ChangeListener {

	private EnhancedGraphic             panel = null;
	
	/**
	 * Constructor
	 * @param panel
	 */
	public EnhancedGraphicListener(EnhancedGraphic panel) {
		this.panel = panel;
