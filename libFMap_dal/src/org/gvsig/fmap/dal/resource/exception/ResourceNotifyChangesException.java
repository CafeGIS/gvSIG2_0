...
public class ResourceNotifyChangesException extends ResourceException {
	...
	private final static String MESSAGE_KEY = "_ResourceNotifyChangesException";

	public ResourceNotifyChangesException(Resource resource) {
