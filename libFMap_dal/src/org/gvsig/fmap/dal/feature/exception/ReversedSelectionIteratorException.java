...
public class ReversedSelectionIteratorException extends DataRuntimeException {
    ...
    private final static String MESSAGE_FORMAT = "Error getting the Features of a reversed selection";
    private final static String MESSAGE_KEY = "_ReversedSelectionIteratorException";
