...
public class PostgreSQLNewStoreParameters extends PostgreSQLStoreParameters
    ...
    public static final String DYNCLASS_NAME = "PostgreSQLNewStoreParameters";
	...
	protected static void registerDynClass() {
		...
		if (DYNCLASS == null) {
			...
			dynClass = dynman.add(DYNCLASS_NAME,
					"new PostgreSQL Store parameters");
			dynClass.extend(PostgreSQLStoreParameters.DYNCLASS_NAME);
			DYNCLASS = dynClass;
		}
