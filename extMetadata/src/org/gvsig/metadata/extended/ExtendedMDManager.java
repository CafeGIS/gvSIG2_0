...
public interface ExtendedMDManager extends MDManager{
	
	/**
	 * Creates a ExtendedMetadata object from the data of a file
	 * @param 	filePath	the path of the file where the metadata is located
	 * @return				an object which implements the ExtendedMetadata interface 
	 */
	 ...
	 * @param 	md		the metadata is obtained from this ExtendedMetadata object
	...
	//El ExtendedMDManager es el que sabe las cosas de la Base de datos (Personal: estan las tablas?)
}